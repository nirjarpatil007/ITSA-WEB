import { n as PLACEHOLDER } from "./router-BSwpajmA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/clubs-CbtmO5xF.js
var clubs = [
	{
		id: "itsa",
		...
		description: "The parent association coordinating all technical, academic, cultural and social activities of the IT Department through 14 specialised teams.",
		activities: [
	...
	},
	{
		...
		description: "The IEEE Student Branch connects students to global technical communities, research exposure and industry networks, and runs awareness and membership drives in the department.",
		activities: [
	...
	},
	{
		...
		description: "MLSC partners with ITSA on hands-on technical training, most recently the Techroom 2.0 launch and its follow-up training sessions.",
	...
	},
	{
		...
		description: "GDGC is one of the professional chapters ITSA collaborates with, named in the association's mission to strengthen industry–academia interaction.",
	...
	},
	{
		...
		description: "The ISR & NSS wing runs the department's community work — cleanliness drives, school awareness programmes and plantation initiatives.",
		activities: [
	...
	},
	{
		...
		description: "The creative wing of ITSA, behind cultural celebrations and craft workshops such as the Diya Painting Workshop.",
